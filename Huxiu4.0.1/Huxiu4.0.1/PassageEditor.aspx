...
<body>
    <form id="form1" runat="server">
        <div>
            标题：<asp:TextBox ID="title" Enabled="false" MaxLength="45" runat="server"></asp:TextBox>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    作者：<asp:DropDownList ID="author" Enabled="false" runat="server"></asp:DropDownList>
            <asp:LinkButton ID="authoradd" Visible="false" runat="server" Text="如果未找到该作者请添加" PostBackUrl="~/AuthorAdd.aspx"></asp:LinkButton>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         <%--按下去就可以编辑了--%>
