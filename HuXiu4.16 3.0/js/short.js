   ...
   function appendAct(){
    ...
    $(window).scroll(function(){
        if($(document).scrollTop()==0)
        {
         ...
         if($("body").height()-$(".footer").innerHeight()-$(".return-top").offset().top-$(".return-top").height()<-32)
         {
            $(".return-top").css({
                "position":"absolute",
...
/*        if($(".container").height()-$(".return-top").offset().top-$(".return-top").height()+30<$(".footer").innerHeight())
         {
             $(".return-top").css({
                "top":$(window).height()-$(".footer").innerHeight()-$(".return-top").height()
            });
         }
         else{
            $(".return-top").css({
                "top":$(window).height()-$(".return-top").height()-20
            });
         }*/
    })
