                ...
                if(dat=="[]"){
                    ...
                    for(j=0;j<jsonObj.length;j++){
                        ...
                        var  titleTime=$("<div>").addClass("title-and-time").appendTo(funs);
                            var title=$("<h1>").text(jsonObj[j].PassageTitle).appendTo(titleTime);
                            var time=$("<p>").text(jsonObj[j].PublishDate).appendTo(titleTime);
                        var funsContent=$("<div>").addClass("funs-content").appendTo(funs)    
                            var contentP=$("<p>").text(jsonObj[j].PassageBody).appendTo(funsContent);
                                var contentA=$("<a>").text("详情>>").appendTo(contentP);
