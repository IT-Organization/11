<%@ Page Language="C#" AutoEventWireup="true" CodeFile="information_list.aspx.cs" Inherits="information_list" MasterPageFile="MasterPage.master" %>
		...
		<div class="listNav"><!--导航-->
			...
			<ul>
				<asp:Repeater ID="Rpt" runat="server" >
                             <ItemTemplate>
                                 <li><a href='<%# "/information_list.aspx?id=" + Eval("PCategoryId") %>'><%#Eval("CategoryName") %></a></li>
                            </ItemTemplate>
                </asp:Repeater>
			</ul>
		</div>
