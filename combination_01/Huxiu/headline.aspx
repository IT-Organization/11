<%@ Page Language="C#" AutoEventWireup="true" CodeFile="headline.aspx.cs" Inherits="headline" %>
            ...
            <asp:Repeater ID="RptDisplaying" runat="server" OnItemDataBound="RptDisplaying_ItemDataBound"  OnItemCommand="RptDisplaying_ItemCommand">
                <ItemTemplate>
                    <tr>
				        ...
				        <td><asp:LinkButton ID="lbTitle" runat ="server" Text ='<%# Eval("Htitle") %>'  CommandName="jumpPage" CommandArgument='<%# Eval("HId") %>'></asp:LinkButton> ></td>
