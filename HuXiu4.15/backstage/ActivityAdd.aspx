...
<body>
    <form id="form1" runat="server">
        ...
        <div>
        活动标题：<asp:TextBox ID="title" MaxLength="45" runat="server" ></asp:TextBox>
            <br />
        <br />
        活动封面：<br />
       ...
       <br /> 
        活动内容：<br />
            <asp:TextBox ID="content" runat="server" Height="219px" Width="318px" TextMode="MultiLine"></asp:TextBox>
            <br />
        <br />
        活动地点：<asp:TextBox ID="where" MaxLength="45" runat="server" Width="213px" ></asp:TextBox>
            <br />
        <br />
        活动时间：
        <%--日期--%>
        ...
        <br />
        备注：<asp:TextBox ID="tips" runat="server" TextMode="MultiLine" MaxLength="95" Height="73px" Width="259px" ></asp:TextBox>
            <br />
        <br />
