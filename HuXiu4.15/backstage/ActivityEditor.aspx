...
<body>
    ...
    <div>
        活动标题：<asp:TextBox ID="title" runat="server" MaxLength="45" Enabled="false" ></asp:TextBox>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <asp:TextBox ID="content" runat="server" TextMode="MultiLine" Height="213px" Width="319px"></asp:TextBox>

        <br />

        <br />
        活动地点：<asp:TextBox ID="where" runat="server" Enabled="false" Width="215px" ></asp:TextBox>
        <br />
        <br />
        活动时间：<br />
        ...
        <br />
        备注：<asp:TextBox ID="tips" Enabled="false" TextMode="MultiLine" MaxLength="95" runat="server" Height="78px" Width="334px" ></asp:TextBox>
        <br />
        <br />
