...
$(document).ready(function(){
    ...
    $(".newsList").on("click", ".share", function () {
        var a = window.location.href;
        var b = window.location.href.lastIndexOf('/') + 1;
        //var c = window.location.href.substring(0, b) + jsonObj[j].imgSrc.substring(1);

        var c = window.location.href.substring(0, b) + $(this).parent(".newsReading").parent(".newsWriter").parent(".news").children(".newsImage").children("img").attr("src");
        window.open("http://service.weibo.com/share/share.php?appkey=1934882415&url=" + a + "&title=" + "shiyixia" + "@艾特网&content=utf-8&pic=" +  c + "#_loginLayer_1490090511099");
    });
})
