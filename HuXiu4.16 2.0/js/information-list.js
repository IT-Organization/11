...
$(document).ready(function(){
           ...
           // url:"/Ajax/PassageList.ashx",
            ...
            success:function(dat){
                ...
                for(j=0;j<jsonObj.length;j++){
                    var infor = $("<div>").addClass("informations").css({"background":"url(" + jsonObj[j].PassageImage + ")","backgroundSize":"auto 100%","backgroundPosition":"center"}).appendTo($(".lists"));
   ...
   $(".lists").on("click",".detail",function(){
        ...
        window.open("PassageContent.aspx" + "?" + "id=" + jsonObj[j].PassageId);
    })
})
