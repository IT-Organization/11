...
<body>
    <form id="form1" runat="server">
        ...
        <div>
        活动标题：<asp:TextBox ID="title" MaxLength="10" runat="server" Width="270px" ></asp:TextBox>
            <br />
        <br />
        活动封面：<br />
       ...
       <br /> 
       活动内容：<br />
            <asp:TextBox ID="content"  runat="server"  TextMode="MultiLine" MaxLength="150" Height="182px" Width="380px" ></asp:TextBox>
            <br />
        <br />
        活动地点：<asp:TextBox ID="where" MaxLength="10" runat="server" ></asp:TextBox>
            <br />
        <br />
        活动时间：
        <%--日期--%>
        ...
        <br />
        备注：<asp:TextBox ID="tips" runat="server"  MaxLength="15" Height="33px" Width="295px" ></asp:TextBox>
            <br />
        <br />
