...
<body>
    ...
    <div>
        活动标题：<asp:TextBox ID="title" runat="server" MaxLength="10" Enabled="false" Width="278px" ></asp:TextBox>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        活动内容：
        <br />
               <asp:TextBox ID="content"  runat="server" Enabled="false" TextMode="MultiLine" MaxLength="150" Height="166px" Width="375px" ></asp:TextBox>
        ...
        <br />
        活动地点：<asp:TextBox ID="where" MaxLength="10" runat="server" Enabled="false" Width="270px" ></asp:TextBox>
        <br />
        <br />
        活动时间：<br />
        ...
        <ContentTemplate> 
        <asp:TextBox ID="requestedDeliveryDateTextBox" Enabled="false" MaxLength="45" runat="server" Width="100" />
        ...
        <br />
        备注：<asp:TextBox ID="tips" Enabled="false"  MaxLength="15" runat="server" Height="29px" Width="299px" ></asp:TextBox>
        <br />
        <br />
