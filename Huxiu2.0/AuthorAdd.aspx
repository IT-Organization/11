...
<body>
    <form id="form1" runat="server">
        ...
        <div >          
            作者名字：<asp:TextBox ID="name" runat="server"></asp:TextBox>
            <br /><br />
            作者头像：
            <br /><br />
        ...
        <input id="lb" type="hidden" runat="server" />
            ...
            作者简介：<br />
            <asp:TextBox ID="summary" runat="server" BorderStyle="Dashed" TextMode="MultiLine" Height="64px" Width="241px" ></asp:TextBox>
    <br />
