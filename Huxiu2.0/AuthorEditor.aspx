...
<body>
    ...
    <div >
            ...
            作者名字：<asp:TextBox ID="name" Enabled="false" runat="server"></asp:TextBox>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <%--按下去就可以编辑了--%>
    <asp:LinkButton ID="btnEditors" runat="server" Text="编辑" OnClick="btnEditors_Click" />    
       ...
       <div id="thelist" class="uploader-list"></div>
        ...
        <input id="lb" type="hidden" runat="server" />
            ...
            作者简介：<br />
            <asp:TextBox ID="summary" runat="server" Enabled="false" BorderStyle="Dashed" TextMode="MultiLine" Height="64px" Width="241px" ></asp:TextBox>
    <br />
