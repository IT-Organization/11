<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Passage.aspx.cs" Inherits="Passage" %>
		...
		<br /><table cellspacing="0" cellpadding="0">
			...
			<asp:Repeater ID="Rpt" runat="server" OnItemCommand="Rpt_ItemCommand">
                <ItemTemplate>
                    ...
                    <tr>
				        <td> <asp:LinkButton ID="lbTitle" runat="server" Text='<%#Eval("PassageTitle") %>' PostBackUrl='<%# "Default2.aspx?id="+ Eval("PassageId") %>'></asp:LinkButton></td>
